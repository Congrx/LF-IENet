...
class CustomLFDataset(Dataset):
    """Custom light field dataset for semantic segmentation. An example of file structure
    is as followed.
    ...
    Args:
        ...
        seg_map_suffix (str): Suffix of segmentation maps. Default: '.npy'
        sai_dir (str, optional): Path to light field sub aperature image. Default: None
        sai_suffix (str): Suffix of light field sub aperature images. Default: '.png'
        dis_dir (str, optional): Path to light field disparity image. Default: None
        dis_map_suffix (str): Suffix of light field sdisparity images. Default: '.npy'
        sai_number (int, optional): Number of light field sub aperature images. Default: 5
    ...
    def __init__(self,
        ...
        self.dis_dir = dis_dir + split + '/' 
        self.dis_map_suffix = dis_map_suffix   
    ...
    def get_dis_info(self, idx):
        return self.img_infos[idx]['dis']
    ...
    def pre_pipeline(self, results):
        ...
        results['dis_prefix'] = self.dis_dir
    ...
    def prepare_train_img(self, idx):
        ...
        dis_info = self.get_dis_info(idx)  
        results = dict(img_info=img_info, ann_info=ann_info, sequence_info=sequence_info,sequence_index=sequence_index,dis_info=dis_info) 
    ...
    def prepare_test_img(self, idx):
        ...
        dis_info = self.get_dis_info(idx)
        results = dict(img_info=img_info, sequence_info=sequence_info,sequence_index=sequence_index,dis_info=dis_info)
        self.pre_pipeline(results)

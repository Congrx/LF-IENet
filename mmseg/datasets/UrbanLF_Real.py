...
class UrbanLFRealDataset(CustomLFDataset):
    """
        UrbanLF dataset.
    """
    ...
    def __init__(self, **kwargs):
        super(UrbanLFRealDataset, self).__init__(
            img_suffix='.png',
            seg_map_suffix='.npy',
            sai_suffix='.png',
            **kwargs)
        ...
        for filename in self.datalist:
            ...
            img_info['ann'] = dict(seg_map=filename + '/label.npy') 
            sais = []
            sais_index = []
            
            if self.sai_number-1 == 4:
                index_list = [[0,10,20,30],[4,13,22,31],[8,16,24,32],[36,37,38,39],[44,43,42,41],[72,64,56,48],[80,70,60,50],[76,67,58,49]]     # 0~39 + 41~80
                random_list = random.sample(index_list,1)[0]  
            
            if self.sai_number-1 == 3:
                index_list = [[10,20,30],[13,22,31],[16,24,32],[37,38,39],[43,42,41],[64,56,48],[70,60,50],[67,58,49]]     # 0~39 + 41~80
                random_list = random.sample(index_list,1)[0]  
            ...
            img_info['dis'] = dict(dis_map=filename + '/disparity_OAVC.npy') 
